class TagRelationship < ApplicationRecord
  ...
  module MessageMethods
    ...
    def retirement_message
      "The #{relationship} [[#{antecedent_name}]] -> [[#{consequent_name}]] #{forum_link} has been automatically retired because it hasn't been used since #{TagRelationshipRetirementService::THRESHOLD.ago.to_date}."
    end
